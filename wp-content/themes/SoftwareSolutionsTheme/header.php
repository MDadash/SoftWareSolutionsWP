...
<head>
  ...
  <link media="screen" rel="shortcut icon" href="<?php bloginfo('template_url') ?>/../../../favicon.ico" type="image/ico">
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-127747493-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-127747493-1');
  </script>
